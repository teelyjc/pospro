...
<div class="container my-4">
  <div class="alert alert-warning" role="alert">
    ...
    <hr>
    <p>ตอนนี้โปรเจ็คเปิดเผยเป็น Open-Source สามารถเข้าชมได้
      <a href="https://github.com/teelyjc/pospro" target="_blank">ที่นี่</a>
    </p>
  </div>
  <h1 class="text-start">
    Cr-PosPro เป็นโปรเจ็ค Point Of Sales <br>
    สำหรับร้านอาหารและคาเฟ่
  </h1>
  <blockquote class="blockquote mt-3">
    <p class="mb-4">"ให้คุณโฟกัสที่การขาย ลดความวุ่นวายเรื่องสต๊อก"</p>
  </blockquote>
</div>
